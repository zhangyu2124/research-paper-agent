 ...
 *
 * Displays a centered welcome screen for new chats with the project logo,
          ...
          >
            ...
            <div className="flex items-end gap-2 px-4 py-3">
              ...
              <Textarea
                ...
                placeholder={userId ? "Ask about papers, methods, comparisons, or research directions..." : "Initializing..."}
